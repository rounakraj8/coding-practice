 ...
 * 
 * 
 * Find the element that appears once Given an array where every element occurs
 * three times, except one element which occurs only once. Find the element that
 * occurs once.
 * 
